...
namespace DataAcess.Repositories
{
    public interface IDepartmentRepository
    {
        ...
        public Task<List<RouteSheetEntity>> GetRouteSheetsAsync(int departmentId);
    ...
    public class DepartmentRepository: IDepartmentRepository
    {
        ...
        public async Task<List<RouteSheetEntity>> GetRouteSheetsAsync(int departmentId)
        {
            var routeSheets = await _mongoDBService.RouteSheetsCollection.Find(new BsonDocument()).ToListAsync();
            return routeSheets.FindAll(x => x.Department == departmentId);
        }
    }
}
